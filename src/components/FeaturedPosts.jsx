      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-4">
            ...
            <NavLink href="/post/1" className="text-blue-600 hover:underline">আরও পড়ুন</NavLink>
          </div>
        </div>
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <Image
          ...
          <div className="p-4">
            ...
            <NavLink href="/post/2" className="text-blue-600 hover:underline">আরও পড়ুন</NavLink>
          </div>
        </div>
      </div>
    </section>)
