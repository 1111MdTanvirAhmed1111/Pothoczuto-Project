...
export default function Sidebar() {
    return (<aside className="lg:w-1/3 space-y-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        ...
        <div className="space-y-4">
          {authors.map((author) => (<div key={author.id} className="flex items-center space-x-4">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          <input type="email" placeholder="আপনার ইমেইল" className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 mb-2"/>
