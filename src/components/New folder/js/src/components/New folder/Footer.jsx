...
export default function Footer() {
    return (<footer className="bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((link) => (<a key={link.name} href={link.href} className="hover:text-gray-800 dark:hover:text-white transition-colors">
